defmodule RelicarioWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RelicarioWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RelicarioWeb.Gettext, "errors", msg, opts)
    end
  end
